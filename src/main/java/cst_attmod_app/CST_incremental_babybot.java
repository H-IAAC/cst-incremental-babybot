...
public class CST_incremental_babybot {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String runId=""; 
        int num_pioneer = 1;
        int stage = 1, exp = 190, res = 256, max_time_graph=100, MAX_ACTION_NUMBER = 500;
        long seed = 1234;
        ...
        AgentMind am = new AgentMind(oc, mode, "drives",n_tables, 10,seed, num_pioneer); // OC, mode, Num_QTables,  PrintStep, seed, num_pioneer, 
