...
if __name__ == "__main__":
    ...
    episodes_ds, mean_rewards_ds, std_rewards_ds = aggregate_every_n(episodes, mean_rewards, std_rewards, n=10)
    _, mean_actions_ds, std_actions_ds = aggregate_every_n(episodes, mean_actions, std_actions, n=10)
    _, mean_angles_ds, std_angles_ds = aggregate_every_n(episodes, mean_angles, std_angles, n=10)
    ...
    df.to_csv(os.path.join(args.output, "estatisticas.csv"), index=False)
